...
import de.ingrid.iplug.ckan.record.DscRecordCreator;
 ...
 */
@Service
public class CkanSearchPlug extends HeartBeatPlug implements IRecordLoader {

    /**
     * The logging object
     */
    private static Log log = LogFactory.getLog(CkanSearchPlug.class);
